...
<<<<<<< HEAD:src/main/java/com/cpmc/collaboration/controller/BaseController.java
...
=======
        String probeUrl = "http://uaf132854.ddns.uark.edu:9002/virtualization-uark/probe?deviceId=CoreXZ";
//        String probeUrl = "http://localhost:9002/virtualization-uark/probe?deviceId=CoreXZ";
>>>>>>> Getting ready for Demo:src/main/java/com/cpmc/central/controller/BaseController.java
        ...
        try {
            ...
            model.addAttribute("deviceId", "CoreXZ");
...
//        String operationsUrl = "http://localhost:9002/virtualization-uark/operate/device";
        HttpClient client = HttpClientBuilder.create().build();
