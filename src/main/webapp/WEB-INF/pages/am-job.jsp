...
=======
        ...
        <p>
        <h5>Operation Id: </h5>
        <input style="text-align: center" type="text" disabled="disabled" name="${operationId}" value="${operationId}"
               id="${operationId}"/>
        </p>
        ...
        <%--FOR DEMO--%>
        <p>
        <h5>Material type (MATERIAL) :</h5>
        <input style="text-align: center" type="text" name="${parameter.id}" id="material" value="PLA"
               disabled="disabled"/>
        </p>
        <p>
        <h5>Number of objects (QUANTITY) :</h5>
        <input style="text-align: center" type="text" name="${parameter.id}" id="quantity" value="1"
               disabled="disabled"/>
        </p>
        <p>
        <h5>Object Name (OBJECT) :</h5>
        <input style="text-align: center" type="text" name="${parameter.id}" id="objName" value="Dragon"
               disabled="disabled"/>
        </p>
...
//            var material = new THREE.MeshLambertMaterial({ambient: 0xFBB917, color: 0xf2f2f2});
            var material = new THREE.MeshLambertMaterial({
                color: 0x909090, overdraw: 1, wireframe: false,
